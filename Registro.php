	      ...
	      <div class="modal-body bodyRegistro">
			    ...
			    <div class="row">
				    <div class="col-xs-6">
				        ...
				        <input type="password" name="password" class="form-control passwordR" required>
				    </div>
				    <div class="col-xs-6">
				        <label for="passwordC">Confirmar Contraseña *</label>
				        <input type="password" name="passwordC" class="form-control passwordC" required>
				    </div>
			    </div>
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
	        <button type="submit" class="btn btnAcepRegistro"">Aceptar</button>
	      </div>
	      </form>
	    </div>
	  </div>
